...
class ReboardingDayDataTest {
    ...
    @BeforeEach
    public void init() {
        vipListService = new VipListService(new HashSet<>(Arrays.asList(new User(100), new User(101))));
        reboardingDayData = new ReboardingDayData(DAILY_CAPACITY, messageSourceAccessorMock, vipListService);
    }
//
//    @Test
